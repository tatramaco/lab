...
New-GPLink -Name "CMD-PS-Logging" -Target "dc=victim,dc=local" -LinkEnabled Yes
New-GPLink -Name "Enhanced-WS-Auditing" -Target "dc=victim,dc=local" -LinkEnabled Yes
New-GPLink -Name "Enhanced-DC-Auditing" -Target "ou=Domain Controllers,dc=victim,dc=local" -LinkEnabled Yes
New-GPLink -Name "Enable-WinRM-and-RDP” -Target "dc=victim,dc=local" -LinkEnabled Yes
New-GPLink -Name "Windows Event Forwarding” -Target "dc=victim,dc=local" -LinkEnabled Yes
